...
exports.getVarRealArray = void 0;
 ...
 */
function getVarRealArray(genericDecoder, buf, flag) {
    ...
    for (var index = 0; index < nbEntries; index++) {
        var decodedValue = (0, float_1.getVarFloat)(genericDecoder, data.buffer, flag);
...
exports.getVarRealArray = getVarRealArray;
