...
exports.getVarStringArray = void 0;
 ...
 */
function getVarStringArray(genericDecoder, buf) {
    ...
    for (var index = 0; index < nbEntries; index++) {
        var decodedValue = (0, string_1.getVarString)(genericDecoder, data.buffer);
...
exports.getVarStringArray = getVarStringArray;
